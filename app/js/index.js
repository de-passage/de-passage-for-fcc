...
(function() {
  var LocalStrategy, app, body_parser, cookieParser, db, db_url, express, google_api_key, https, mongo, multer, passport, password, path, port, searchImages, secret, session, upload, user, util;
